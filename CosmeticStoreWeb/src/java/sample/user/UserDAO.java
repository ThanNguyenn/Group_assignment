...
public class UserDAO {
    ...
    private static final String LOGIN = "SELECT fullName, roleID FROM tblUsers WHERE userID=? AND password=? AND status!= 0";
//    private static final String SEARCH = "SELECT userID, fullName, roleID FROM tblUsers WHERE fullName LIKE ?";
    ...
    private static final String SOFT_DELETE = "UPDATE tblUsers SET status=0 WHERE userID=?";
    private static final String TOP1USER = "SELECT TOP 1 userID,fullName FROM tblUsers";
    private static final String GET_USER = "SELECT fullName, roleID FROM tblUsers WHERE userID=? ";
    ...
    public boolean update(String userID, String fullName, String roleID) throws SQLException, ClassNotFoundException {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
        try {
    ...
    public boolean softDelete(String userID) throws SQLException, ClassNotFoundException {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
        try {
    ...
    public UserDTO getTop1User() throws SQLException {
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
        ...
        try {
            conn = DBUtils.getConnection();
            ptm = conn.prepareStatement(TOP1USER);
            rs = ptm.executeQuery();
            if (rs.next()) {
                String userID = rs.getString("userID");
                String fullName = rs.getString("fullName");
                user = new UserDTO(userID, fullName, "US", "");
            }
        ...
        try {
            ...
            if (conn != null) {
                ...
                if (rs.next()) {
                    String fullName = rs.getString("fullName");
                    String roleID = rs.getString("roleID");
                    user = new UserDTO(uId, fullName, roleID, "");
                }
            }
        } finally {
            if (rs != null) {
